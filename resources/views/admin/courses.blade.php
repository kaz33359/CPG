                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="{{ route('addcourse') }}" method="POST">
                                                    ...
                                                    @if ($errors->any())
                                                        ...
                                                        @endforeach
                                                    @endif
                                                    <button type="submit" class="btn btn-primary mt-3 message">Add Course</button>
                                                </form>
                            ...
                            <table id="html5-extension" class="table style-3 table-hover non-hover" style="width:100%">
                                ...
                                <tbody>  
                                    @foreach ($courses as $course)
                                        ...
                                        @if ($course['status'] == 1)
                                        <td><button class="btn btn-success mb-2"><a href="{{ url('/status_course',$course->id) }}">Active</a></button></td>
                                        @else
                                        <td><button class="btn btn-danger mb-2"><a href="{{ url('/status_course',$course->id) }}">Deactive</a></button></td>
                                        @endif
                                        

                                       <td class="text-center">
                                            <ul class="table-controls">
                                                <li><a href="{{ route('viewCourse',$course->id) }}" class="bs-tooltip"
                                                ...
                                                <li>
                                                    <a href="{{url('/delete_course',$course->id)}}" class="bs-tooltip"
                                                        data-toggle="tooltip" data-placement="top" title=""
