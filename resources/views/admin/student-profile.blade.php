...
<head>
    ...
    <title>CPG | Student Profile</title>
                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Student Profile</a></li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="row layout-spacing">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-5 col-sm-12 layout-top-spacing">
                        ...
                        <div class="education layout-spacing ">
                            <div class="widget-content widget-content-area ">
                                <h3 class="">Account Status</h3>
                                @foreach ($students_data as $status)
                                    @if ($status->status ==1)
                                    <button class="btn btn-success mb-2 "><a href="{{ url('/status_student',$status->id) }}">Active</a></button>
                                    @else
                                    <button class="btn btn-danger mb-2 "><a href="{{ url('/status_student',$status->id) }}">Deactive</a></button>
                                    @endif
                                @endforeach
                    ...
                    <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                        ...
                        <div class="bio layout-spacing ">
                            <div class="widget-content widget-content-area ">
                                <h3 class="">Student Course Info</h3>
                                @foreach ($students_data as $course)
