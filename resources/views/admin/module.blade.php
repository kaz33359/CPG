...
<body class="alt-menu sidebar-noneoverflow">
        ...
        <div class="topbar-nav header navbar" role="banner">
            <nav id="topbar">
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu ">
                        <a href="{{  route('courses') }}" aria-expanded="true"
                            class="dropdown-toggle autodroprown">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu single-menu active ">
                        <a href="{{ route('module') }}" aria-expanded="true"
                            class="dropdown-toggle autodroprown">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu single-menu ">
                        <a href="{{ route('chapter') }}" aria-expanded="true"
                            class="dropdown-toggle autodroprown">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu single-menu ">
                        <a href="{{ route('topic') }}" aria-expanded="true"
                            class="dropdown-toggle autodroprown">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a
                                    href="javascript:void(0);">Module</a></li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <table id="html5-extension" class="table style-3 table-hover non-hover" style="width:100%">
                                ...
                                <tbody>  
                                    @foreach ($modules_data as $modules)
                                        <tr>
                                        <td>{{ $modules['id'] }}</td>
                                        <td>{{ $modules['module_name'] }}</td>
                                        <td>{{ $modules['course_name'] }}</td>
                                        @if ($modules['status'] == 1)
                                        <td><button class="btn btn-success mb-2"><a href="{{ url('/status_module',$modules->id) }}">Active</a></button></td>
                                        @else
                                        <td><button class="btn btn-danger mb-2"><a href="{{ url('/status_module',$modules->id) }}">Deactive</a></button></td>
                                        @endif
                                        

                                       <td class="text-center">
                                            <ul class="table-controls">
                                                <li><a href="products_view.html" class="bs-tooltip"
                                                ...
                                                <li>
                                                    <a href="{{url('/delete_module',$modules->id)}}" class="bs-tooltip"
                                                        data-toggle="tooltip" data-placement="top" title=""
    ...
    <script src="{{ asset('cplugins/apex/apexcharts.min.js') }}"></script>
    <script src="{{ asset('admin-assets/assets/js/dashboard/dash_2.js') }}"></script>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
