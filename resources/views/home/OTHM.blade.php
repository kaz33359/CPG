					...
					<div class="col-xl-6 offset-xl-3 text-center">
						<div class="breadcrumb_content">
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">OTHM Level 6 Safety Diploma</li>
							</ol>
						</div>
					</div>
				</div>
								...
								<div class="courses_single_container">
									...
									<div class="cs_row_two">
										<div class="cs_overview">
											...
											<p class="mb30">OTHM qualifications are approved and regulated by Ofqual,
												(Office of the Qualifications and Examinations Regulation) learners are
												eligible to progress to top-up degree and masters programmes at many
												universities in UK and overseas with advanced standing.</p>
											...
											<p></p>
											<h4 class="subtitle">Advantages of OTHM Qualifications:</h4>
											<p class="mb30">•<strong> IOSH (UK) GradIOSH Membership: </strong> </p>
											<p class="mb30">OTHM Level 6 Diploma holders are eligible for Graduate Level
												Membership with IOSH (UK) – GradIOSH and then Plan their CPD & IPD for
												attaining Chartered Membership status “CMIOSH” with IOSH, UK in future.
											</p>
											<p></p>
											<ul class="cs_course_syslebus">
												<h4>The Salient features of Ofqual Accredited OTHM Level 6 Diploma in
													OHS are:</h4>
												<li><i class="fa fa-check"></i>
													<p>UK Government body Ofqual accredited Level 6 Diploma. </p>
												</li>
												<li><i class="fa fa-check"></i>
													<p>This qualification is equivalent to Graduation / Honours Degree
														Qualification in OHS </p>
												</li>
												<li><i class="fa fa-check"></i>
													<p>NO Exams, Only assignments are needed to be submitted for each
														Unit </p>
												</li>
												<li><i class="fa fa-check"></i>
													<p>Easiest and Quickest way to achieve GradIOSH membership.</p>
												</li>
											...
											<ul class="cs_course_syslebus">
												...
												<!--<li><i class="fa fa-check"></i><p>This qualification is equivalent to Graduation / Honours Degree Qualification in OHS    </p></li>-->
												<!--<li><i class="fa fa-check"></i><p>NO Exams, Only assignments are needed to be submitted for each Unit </p></li>-->
												<!--<li><i class="fa fa-check"></i><p>Easiest and Quickest way to achieve GradIOSH membership.</p></li>-->
												<!--<li><i class="fa fa-check"></i><p>Health and Safety Law, Regulation and Influence</p></li>-->
											</ul>
										</div>
									</div>
