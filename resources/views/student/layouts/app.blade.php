		...
		<div class="container-fluid">
		    ...
		    <nav>
		        ...
		        <a href="#" class="navbar_brand float-left dn-smd">
		            <img class="logo2 img-fluid" src="{{ asset('images/header-logo.png') }}" alt="header-logo.png">
		        ...
		        <ul class="header_user_notif pull-right dn-smd">
                    ...
                    <li class="user_setting">
                            <div class="dropdown">
	                		<a class="btn dropdown-toggle" href="#" data-toggle="dropdown"><img class="rounded-circle" src="{{ asset('images/team/e1.png') }}" alt="e1.png"></a>
						    <div class="dropdown-menu">
						    	<div class="user_set_header">
						    		<img class="float-left" src="{{ asset('images/team/e1.png') }}" alt="e1.png">
							    	<p>{{ session('STUDENT_NAME') }}<br><span class="address">{{ session('STUDENT_EMAIL') }}</span></p>
									<p>{{ session('STUDENT_ID') }}</p>
						    	</div>
		...
		<div class="dashboard_sidebars">
			<div class="user_board">
				<div class="dashbord_nav_list">
					<ul>
						<li class="active"><a href="dashboard.html"><span class="flaticon-puzzle-1"></span> Dashboard</a></li>
		...
		@yield('content')
						...
						<div class="col-lg-6 offset-lg-3">
							<div class="copyright-widget text-center">
								<p class="color-black2">Copyright CPG © 2020. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
