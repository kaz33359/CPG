			...
			<div class="container-fluid">
				...
				<nav>
					...
					<div class="menu-toggle">
						<img class="nav_logo_img img-fluid" src="{{ URL('images/header-logo3.png') }}" alt="header-logo3.png">
				...
				<div class="row">
					<div class="col-sm-4 col-md-3 col-lg-3 col-xl-2 pb15 pt15">
						<div class="logo-widget home3">
							<img class="img-fluid" src="{{ URL('images/header-logo3.png') }}" alt="header-logo3.png">
							<span></span>
						</div>
					</div>
					<div class="col-sm-8 col-md-5 col-lg-6 col-xl-6 pb25 pt25 brdr_left_right home3">
						<div class="footer_menu_widget home3">
							<ul>
								...
								<li class="list-inline-item"><a href="{{ route('CSP-ASP-training') }}">Course</a></li>
								<li class="list-inline-item"><a href="{{ route('consultancy-services') }}">Business Solutions</a></li>
